...
type PixelBlastProps = {
  ...
  edgeFade?: number;
  noiseAmount?: number;
  intensity?: number; // New prop for background intensity
};
...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  const getThemeColor = () => {
    ...
    if (theme === 'dark') {
      // Use a subtle blue/purple for dark theme
      return '#3b82f6'; // blue-500 equivalent
    } else {
      // Use a more vibrant color for light theme
      return '#8b5cf6'; // violet-500 equivalent
    }
  };
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const uniforms = {
        ...
        uRippleIntensity: { value: rippleIntensityScale * intensity },
      ...
      t.uniforms.uColor.value.set(getThemeColor());
      t.uniforms.uScale.value = patternScale;
      t.uniforms.uDensity.value = patternDensity;
      t.uniforms.uPixelJitter.value = pixelSizeJitter;
      t.uniforms.uEnableRipples.value = enableRipples ? 1 : 0;
      t.uniforms.uRippleIntensity.value = rippleIntensityScale * intensity;
